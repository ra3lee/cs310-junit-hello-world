...
public class ExampleTest {
    ...
    private String expectedReverse1, expectedReverse2, expectedReverse3, newTestMethod;
    ...
    public void setUp() {
        ...
        newTestMethod = "ihsus emos tnaw I";
    }
    ...
    {
        String actual = main.reverse("I want some sushi");
        assertEquals(newTestMethod, actual);
    }
